...
<body class="sub_page">
  ...
  <section class="product_section layout_padding">
      ...
      <div class="container layout_padding2-top">
        <div class="row">
          <div class="col-md-6 mx-auto">
            ...
            <div>
                <input id="txtNombre" name="txtNombre" type="text" placeholder="Nombre" value="<?php echo "{$resultado['NOMBRE_ST']}";?>">
              </div>
              <div>
                <input id="txtDescripcion" name="txtDescripcion" type="text" class="message-box" placeholder="Descripción" value="<?php echo "{$resultado['DESCRIPCION_ST']}";?>">
              </div>
              <div>
    ...
    <?php 
      include "./actions/editarSubcategoria.php";
      include 'footer.php'
    ?>
