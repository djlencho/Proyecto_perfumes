...
<body class="sub_page">
    <?php 
        ...
        $sql = "SELECT ID_PD, NOMBRE_PD, NOMBRE_INTERNO_PD, MARCAS_PD, DESCRIPCION_PD, SKU_PD FROM PRODUCTOS_T WHERE ID_PD = $id AND ESTATUS_PD = 1";
  ...
  <section class="product_section layout_padding">
      ...
      <div class="container layout_padding2-top">
        <div class="row">
          <div class="col-md-6 mx-auto">
            ...
            <div>
                <input disabled id="txtNombre" name="txtNombre" type="text" placeholder="Nombre" value="<?php echo "{$resultado['NOMBRE_PD']}";?>">
              </div>
              <div>
                <input disabled id="txtNombreInterno" name="txtNombreInterno" type="text" placeholder="Nombre interno" value="<?php echo "{$resultado['NOMBRE_INTERNO_PD']}";?>">
              </div>
              <div>
                <input disabled id="txtSku" name="txtSku" type="text" placeholder="SKU" value="<?php echo "{$resultado['SKU_PD']}";?>">
              </div>
              <div>
                <select disabled id="txtMarca" name="txtMarca" class="form-control mb-3">
              ...
              <div>
                <select disabled id="txtSubcategoria" name="txtSubcategoria" class="form-control mb-3">
              ...
              <div>
                <input disabled id="txtDescripcion" name="txtDescripcion" type="text" class="message-box" placeholder="Descripción" value="<?php echo "{$resultado['DESCRIPCION_PD']}";?>">
              </div>
    ...
    <?php 
      include "./actions/eliminarProducto.php";
      include 'footer.php'
    ?>
