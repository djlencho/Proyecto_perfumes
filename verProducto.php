...
<body class="sub_page">
  ...
  <section class="product_section layout_padding">
      ...
      <div class="container layout_padding2-top">
        <div class="row">
          <div class="col-md-6 mx-auto">
            ...
            <div>
                <input id="txtNombre" name="txtNombre" type="text" placeholder="Nombre" value="<?php echo "{$resultado['NOMBRE_PD']}";?>">
              </div>
              <div>
                <input id="txtNombreInterno" name="txtNombreInterno" type="text" placeholder="Nombre interno" value="<?php echo "{$resultado['NOMBRE_INTERNO_PD']}";?>">
              </div>
              <div>
                <input id="txtSku" name="txtSku" type="text" placeholder="SKU" value="<?php echo "{$resultado['SKU_PD']}";?>">
              </div>
              <div>
              ...
              <div>
                <select id="txtSubcategoria" name="txtSubcategoria" class="form-control mb-3">
              ...
              <div>
                <input id="txtDescripcion" name="txtDescripcion" type="text" class="message-box" placeholder="Descripción" value="<?php echo "{$resultado['DESCRIPCION_PD']}";?>">
              </div>
    ...
    <?php 
      include "./actions/editarProducto.php";
      include 'footer.php'
    ?>
